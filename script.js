window.onload = function() {
  ...
  window.addEventListener('scroll', function(e) {
    body.style.backgroundPosition = "0px " + 0.5*window.scrollY + "px";
    document.getElementById("cellA").style.backgroundPosition = "0px " + (0.5*cell_height + 0.1*(cell_height/screen.height)*(window.scrollY+window.innerHeight-document.getElementById("cellA").offsetTop)) + "px";
