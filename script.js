window.onload = function() {
  ...
  window.addEventListener('scroll', function(e) {
    body.style.backgroundPosition = "0px " + 0.5*window.scrollY + "px";
    document.getElementById("cellA").style.backgroundPosition = "0px " + ((cell_height/screen.height)*(window.scrollY+screen.height-document.getElementById("cellA").offsetTop)) + "px";
