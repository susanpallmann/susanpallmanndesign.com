window.onload = function() {
  ...
  document.getElementById("cellB").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellB").offsetTop)) + "px";
  document.getElementById("cellC").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellC").offsetTop)) + "px";
  document.getElementById("cellD").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellD").offsetTop)) + "px";
  document.getElementById("cellE").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellE").offsetTop)) + "px";
  document.getElementById("cellF").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellF").offsetTop)) + "px";
  document.getElementById("cellG").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellG").offsetTop)) + "px";
  document.getElementById("cellH").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellH").offsetTop)) + "px";
  document.getElementById("cellI").style.backgroundPosition = "0px " + (-50+(cell_height/screen.height)*(window.scrollY-document.getElementById("cellI").offsetTop)) + "px";
